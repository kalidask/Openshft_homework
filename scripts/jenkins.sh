...
oc policy add-role-to-user edit system:serviceaccount:ci-cd:jenkins -n tasks
oc policy add-role-to-group system:image-puller system:serviceaccounts:ci-cd -n tasks
